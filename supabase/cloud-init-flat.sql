...
create policy "public can create event requests" on public.event_requests for insert to anon with check (status = 'pending');

create policy "admins manage event requests" on public.event_requests for all to authenticated using (public.is_admin()) with check (public.is_admin());

create policy "events visible to signed in users" on public.events for select to authenticated using (true);

create policy "signed in users manage events" on public.events for all to authenticated using (true) with check (true);
...
create policy "signed in users manage assignments" on public.event_assignments for all to authenticated using (true) with check (true);

create policy "attendance visible to signed in users" on public.event_attendance for select to authenticated using (true);

create policy "signed in users manage attendance" on public.event_attendance for all to authenticated using (true) with check (true);

create policy "public can create registration requests" on public.registration_requests for insert to anon with check (status = 'pending');

create policy "admins manage registration requests" on public.registration_requests for all to authenticated using (public.is_admin()) with check (public.is_admin());
...
create policy "admins manage knowledge pages" on public.knowledge_pages for all to authenticated using (public.is_admin()) with check (public.is_admin());
...
create policy "admins manage knowledge suggestions" on public.knowledge_suggestions for all to authenticated using (public.is_admin()) with check (public.is_admin());

create policy "landing content visible to everyone" on public.landing_content for select to anon, authenticated using (true);

create policy "admins manage landing content" on public.landing_content for all to authenticated using (public.is_admin()) with check (public.is_admin());

create policy "equipment visible to signed in users" on public.equipment_items for select to authenticated using (true);

create policy "signed in users manage equipment" on public.equipment_items for all to authenticated using (true) with check (true);

create policy "equipment tags visible to signed in users" on public.equipment_tags for select to authenticated using (true);

create policy "signed in users manage equipment tags" on public.equipment_tags for all to authenticated using (true) with check (true);

create policy "app options visible to signed in users" on public.app_options for select to authenticated using (true);

create policy "signed in users manage app options" on public.app_options for all to authenticated using (true) with check (true);
