...
import type { LandingCounts } from "@/lib/landing-stats";
import type { LandingContent, LandingImpression } from "@/lib/types";

type AuthPanel = "landing" | "login" | "register";

export function LoginPageClient({ initialCounts, initialLanding }: { initialCounts: LandingCounts; initialLanding: LandingContent }) {
  ...
  const [landingCounts] = useState(initialCounts);
  ...
  const landing = ready ? data.landingContent : initialLanding;
    ...
    <main className="landing-screen">
        ...
        {stats.map((stat, index) => {
          ...
          return (
            <article key={stat.label}>
              <Icon size={20} />
              <strong>
                {(statsVisible ? visibleStats[index] : stat.value) ?? stat.value}{stat.suffix}
              </strong>
      ...
      <section className="landing-impressions landing-reveal">
        ...
        <div className="impression-grid">
          {landing.impressions.map((impression) => (
            ...
            >
              <img alt={impression.title} decoding="async" loading="lazy" src={impression.images[0]} />
      ...
      <section className="landing-team landing-reveal" id="team">
        ...
        <div className="team-portrait-card">
          <img alt="Technikteam bei einer Veranstaltung" decoding="async" loading="lazy" src={landing.teamImage} />
